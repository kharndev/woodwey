...
import { CatalogRequestModal } from '@/components/catalog-request'
...
export default function RootLayout({children}:{children:React.ReactNode}){return <html lang="en" data-scroll-behavior="smooth"><body id="main-content" className={`${sans.variable} ${serif.variable} font-sans antialiased`}>{children}<CatalogRequestModal/><MediaProtection/><WhatsApp/>{process.env.NODE_ENV==='production'&&<Analytics/>}</body></html>}
